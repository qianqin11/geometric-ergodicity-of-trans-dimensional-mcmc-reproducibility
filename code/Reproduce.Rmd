...
This plot compares the bounds on $1-\|P\|_{\Pi}$ produced by equations (4) and (5) in the manuscript. et $k_{\scriptsize\mbox{max}} = 5, 10, ..., 40$, and let $n = 15$. We calculate the bounds for $\|P\|_{\Pi}$ via the two equations.
...
The following code chunk simulates the chain. We only need the component $K(t)$.
